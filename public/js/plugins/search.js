...
var searchFunc = function (path, input_id, content_id, result_id) {
    ...
    $result.innerHTML = "Loading search function...";
    $.ajax({
        url: path,
        dataType: "xml",
        xhr: function () {
            ...
            xhr.addEventListener("progress", function (evt) {
                if (evt.lengthComputable) {
                    ...
                    $result.innerHTML = "Loading search function... " + percentComplete.toFixed(2) + "%";
                }
            }, false);
            return xhr;
        },
        success: function (xmlResponse) {
            ...
            function search() {
                ...
                if (str.indexOf('<li>') === -1) {
                    $result.textContent = "";
                    return $content.innerHTML = "<ul><span class='result-empty'>No content found, please try another search term~<span></ul>";
                }
                else
                {
                    $result.innerHTML = "Found <b><font size=\"5px\">" + str.match(/<li>/g).length + "</font></b> results.";
                }
        ...
        error: function (xhr, status, error) {
            ...
            $result.innerHTML = "Search function failed to load, please check the console log for details.";
        }
    });
}